...
function loadimg_Callback(hObject, eventdata, handles)                           %load image button
...
function localiseimg_Callback(hObject, eventdata, handles)                      %detect iris
...
function normaliseimg_Callback(hObject, eventdata, handles)                              %normalise iris
...
function gen_template_Callback(hObject, eventdata, handles)                                %generate template
