...
%lines 35 to 43 compute the whole line integral
...
%lines 46 onwards compute the lateral line integral(to prevent occlusion affecting the results,the pixel average is taken only along the lateral portions)
