...
function LocalisedImg_Callback(hObject, eventdata, handles)             %view localised image
...
function directDaugman_Callback(hObject, eventdata, handles)            %detect iris by dougman operator
...
function Proposed_Callback(hObject, eventdata, handles)                  %detect iris by proposed operator
